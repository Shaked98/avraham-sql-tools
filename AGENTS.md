...
`docs/benchmarks/` holds four *executed* benchmark writeups (5.7 vs
8.0 general — stock and parity-pinned — + huge-text, 5.7 vs MariaDB
10.11) feeding the README "Benchmarks" cross-engine table. Every
number came from a real run — never hand-edit them; a new benchmark
run gets a new dated file (and
